...
import com.example.printapplication.services.PrintCompleteService;
import com.example.printapplication.services.PrintUtility;
import com.example.printapplication.services.WifiScanner;

import java.io.File;

public class MainActivity extends Activity implements Observer, PrintCompleteService {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBtnDownloadAndPrint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mPrintDialog.show();
                mObservable.attach(MainActivity.this);
        ...
        mBtnPrintFromFragment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent iNext = new Intent(MainActivity.this, PrintFragmentActivity.class);
                startActivity(iNext);
            }
        });
